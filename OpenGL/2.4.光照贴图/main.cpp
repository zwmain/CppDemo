...
#define VER_GLSL_FILE "../../../2.4.光照贴图/ver.glsl"
#endif

#ifndef FRG_GLSL_FILE
#define FRG_GLSL_FILE "../../../2.4.光照贴图/frg.glsl"
#endif

#ifndef LIGFRG_GLSL_FILE
#define LIGFRG_GLSL_FILE "../../../2.4.光照贴图/light-frg.glsl"
#endif

#ifndef LIGVER_GLSL_FILE
#define LIGVER_GLSL_FILE "../../../2.4.光照贴图/light-ver.glsl"
#endif

#ifndef TEX_DIR
#define TEX_DIR "../../../assets/texture"
#endif
...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(800, 600, "2.4.LightImage", NULL, NULL);
    if (window == NULL) {
    ...
    // 加载图片并生成纹理
    std::string imgPath = TEX_DIR;
    imgPath += "/container2.png";
    ...
    // 加载图片并生成纹理
    imgPath = TEX_DIR;
    imgPath += "/container2_specular.png";
    data = nullptr;
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        lampShader.use();
        glm::mat4 model = model = glm::mat4(1.0);
